    ...
    <head>
       ...
       <link rel="icon" type="image/png" href="/dark/img/tsIcono.png"/>
        ...
        <style>
            ...
            /*Color del fondo claro 243 244 246 */
            .bg-gray-100{--tw-bg-opacity:1;background-color:rgb(25 28 36 / var(--tw-bg-opacity))}/*Color del fondo claro*/
            
            .bg-white{--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity))}.bg-red-50{--tw-bg-opacity:1;background-color:rgb(254 242 242 / var(--tw-bg-opacity))}.bg-blue-50{--tw-bg-opacity:1;background-color:rgb(6 58 164 / var(--tw-bg-opacity))}
            ...
            .from-gray-700\/50{--tw-gradient-from:rgb(55 65 81 / 0.5);--tw-gradient-to:rgb(55 65 81 / 0);--tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to)}.via-transparent{--tw-gradient-to:rgb(0 0 0 / 0);--tw-gradient-stops:var(--tw-gradient-from), transparent, var(--tw-gradient-to)}.bg-center{background-position:center}.stroke-red-500{stroke:#ef4444}.stroke-gray-400{stroke:#9ca3af}.p-6{padding:1.5rem}.px-6{padding-left:1.5rem;padding-right:1.5rem}.text-center{text-align:center}.text-right{text-align:right}.text_left{text-align:left}.text-xl{font-size:1.25rem;line-height:1.75rem}.text-sm{font-size:0.875rem;line-height:1.25rem}.font-semibold{font-weight:600}.leading-relaxed{line-height:1.625}.text-gray-600{--tw-text-opacity:1;color:rgb(75 85 99 / var(--tw-text-opacity))}.text-gray-900{--tw-text-opacity:1;color:rgb(17 24 39 / var(--tw-text-opacity))}.text-gray-500{--tw-text-opacity:1;color:rgb(107 114 128 / var(--tw-text-opacity))}.underline{-webkit-text-decoration-line:underline;text-decoration-line:underline}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.shadow-2xl{--tw-shadow:0 25px 50px -12px rgb(0 0 0 / 0.25);--tw-shadow-colored:0 25px 50px -12px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-gray-500\/20{--tw-shadow-color:rgb(107 114 128 / 0.2);--tw-shadow:var(--tw-shadow-colored)}.transition-all{transition-property:all;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.selection\:bg-red-500 *::selection{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}.selection\:bg-blue-500 *::selection{--tw-bg-opacity:1;background-color:rgb(6 58 164 / var(--tw-bg-opacity))}.selection\:text-white *::selection{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}.selection\:bg-red-500::selection{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}.selection\:bg-blue-500::selection{--tw-bg-opacity:1;background-color:rgb(6 58 164 / var(--tw-bg-opacity))}.selection\:text-white::selection{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}.hover\:text-gray-900:hover{--tw-text-opacity:1;color:rgb(235 22 22 / var(--tw-text-opacity))}.hover\:text-gray-700:hover{--tw-text-opacity:1;color:rgb(235 22 22 / var(--tw-text-opacity))}.focus\:rounded-sm:focus{border-radius:0.125rem}.focus\:outline:focus{outline-style:solid}.focus\:outline-2:focus{outline-width:2px}.focus\:outline-red-500:focus{outline-color:#ef4444}.group:hover .group-hover\:stroke-gray-600{stroke:#4b5563}.z-10{z-index: 10}@media (prefers-reduced-motion: no-preference){.motion-safe\:hover\:scale-\[1\.01\]:hover{--tw-scale-x:1.01;--tw-scale-y:1.01;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}}@media (prefers-color-scheme: dark){ /*.hover\:text-gray-900:hover{--tw-text-opacity:1;color:rgb(17 24 39 / var(--tw-text-opacity))} <-- Azul / .hover\:text-gray-700:hover{--tw-text-opacity:1;color:rgb(55 65 81 / var(--tw-text-opacity))} <-- Blanco */
                /*Color del fondo oscuro 17 24 39 Original */
                .dark\:bg-gray-900{--tw-bg-opacity:1;background-color:rgb(25 28 36 / var(--tw-bg-opacity))}/*Color del fondo oscuro*/
                
                .dark\:bg-gray-800\/50{background-color:rgb(31 41 55 / 0.5)}.dark\:bg-red-800\/20{background-color:rgb(153 27 27 / 0.2)}
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10 padding-encabezado" style="width: 100%; background-color: #191c24;"> <!--z-10">-->
                    @auth
                        ...
                        <div style="margin-top: 5px;">
                            <a class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" onclick="document.getElementById('logout-form').submit();" style="cursor: pointer; font-size: 16px;">
                                {{ __('Cerrar sesión') }}
                            </a>  
                        </div>

                    @else
                        <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" style="font-size: 16px;">
                            Iniciar sesión
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('type-register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" style="font-size: 16px;">
                                Registrarse
                            </a>
                        @endif
                    @endauth
            ...
            <div id="body_pagina" class="max-w-7xl mx-auto p-6 lg:p-8 padding-footer padding-bienvenida"  style="background-color: #191c24;">
                ...
                <div class="flex justify-center" style="margin-top: 10px; display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
                    @auth <!--Cuando el usuario este logueado muestrame lo sigiente-->
                        ...
                        @can('only-superadmin')                            
                            <button onclick="window.location.href = '/administrador';" class="boton" style="margin: 10px; font-size: 18px; width: 170px;"> <!--style="margin-left: 20px;"-->
                                Administradores
                            </button>
                    ...
                    @auth <!--Cuando el usuario este logueado muestrame lo sigiente-->
                        ...
                        @can('only-superadmin')
                            <button onclick="window.location.href = '/categoria';" class="boton" style="margin: 10px; font-size: 18px; width: 170px;"> <!--style="margin-left: 20px;"-->
                                Categorías
                            </button>
                        @endcan
