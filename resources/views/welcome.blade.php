    ...
    <head>
       ...
       <link rel="icon" type="image/png" href="/dark/img/tsIcono.png"/>
        ...
        <style>
            ...
            .bg-gray-100{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))} /*Color del fondo*/
            .bg-white{--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity))}.bg-red-50{--tw-bg-opacity:1;background-color:rgb(254 242 242 / var(--tw-bg-opacity))}
            /*Color del fondo*/
            ...
            @if (Route::has('login'))
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        ...
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> <!--class="focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"-->
                            Perfil (Dashboard)
                        </a>
                        ...
                        <div style="margin-top: 5px;">
                            <a class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" onclick="document.getElementById('logout-form').submit();" style="cursor: pointer; font-size: 15px;">
                                {{ __('Cerrar sesión') }}
                            </a>  
                        </div>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="flex justify-center" style="margin-top: 30px;">
                    ...
                    @auth <!--Cuando el usuario este logueado muestrame lo sigiente-->
                        ...
                        @can('only-admin')
                            <button onclick="window.location.href = '/categoria';" class="boton" style="margin-left: 25px;"> <!--style="margin-left: 20px;"-->
                                Categorías
                            </button>
                        @endcan
